...
##### Bool
Няма смисъл да ползваме switch, когато проверяваме стойността на булева променлива, тъй като там имаме само 2 случая (когато е true или когато е false) и реално нямаме никаква полза от jump таблицата, която вероятно компилаторът ще направи.
```c++
bool b;
std::cin >> b;
