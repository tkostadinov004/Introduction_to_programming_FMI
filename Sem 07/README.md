...
**2.** Наричаме едно изречение *анаграма* на друго, ако едното изречение може да се образува чрез разместване на символите на другото изречение. За целите на задачата, едно изречение е анаграма на друго, игнорирайки всички символи, които не са букви, и не правейки разлика между малки и големи букви. По този начин изречението "Astronomer?!" е анаграма на "Moon starter.", понеже и двете имат по еднакъв брой от всяка буква.</br>
Напишете функция, която приема два символни низа, представляващи изречения и връща дали първото изречение е анаграма на второто. При проверката игнорирайте всички символи, които не са латински букви.
<table>
   <tr><th><strong>Вход</strong></th><th><strong>Изход</strong></th></tr>
